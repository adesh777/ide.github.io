...
$(document).ready(function () {
    ...
    console.log("Hey, Technovation Spark IDE is open-sourced: https://github.com/judge0/ide. Have fun!");
    ...
    $("body").keydown(function (e) {
        ...
        if (keyCode == 120) { // F9
            ...
            e.preventDefault();
            var url = prompt("Enter URL of Technovation Spark API:", apiUrl);
            if (url != null) {
                url = url.trim();
            }
            if (url != null && url != "") {
...
var cSource = "\
// Powered by Technovation Spark\n\
#include <stdio.h>\n\
\n\
int main(void) {\n\
    printf(\"Hello Technovation Spark!\\n\");\n\
    return 0;\n\
}\n\
";
...
Technovation Spark IDE assumes that content of executable is Base64 encoded.\n\
\n\
...
var sqliteSource = "\
-- On Technovation Spark IDE your SQL script is run on chinook database (https://www.sqlitetutorial.net/sqlite-sample-database).\n\
-- For more information about how to use SQL with Technovation Spark API please\n\
...
var c3Source = "\
// On the Technovation Spark IDE, C3 is automatically\n\
...
var nimSource = "\
# On the Technovation Spark IDE, Nim is automatically\n\
...
var bosqueSource = "\
// On the Technovation Spark IDE, Bosque (https://github.com/microsoft/BosqueLanguage)\n\
